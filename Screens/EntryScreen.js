  ...
  */
  ...
  useEffect(()=> {
    ...
    async function handleSubmit(){
      ...
      const conversation = [
        {role:"system", content:"You are a writing assistant. Help writers with the request you receive and deliver your response as though you are speaking to them. "},
      ...
      console.log(raw)
      const response = await fetch('http://127.0.0.1:8000/gpt/flourish', requestOptions)
      const respJson = await response.json()
      storeEntryData(usageCount-1)
      getEntryData()
      console.log(respJson)
      setAiResponse(respJson.choices[0].message.content)
    }
    }
